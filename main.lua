...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Funky-Friday-autoplayer-Modded/uwuware-ui/main/main.lua"))()
...
local window = library:CreateWindow('Funky Friday') do
    local folder = window:AddFolder('Autoplayer') do
        ...
        folder:AddSlider({ text = 'Release delay (ms)', flag = 'autoDelay', min = -50, max = 900, value = 100 })
    end
